...
public class PrintExcel {
    public static void main(String[] args) {
        ...
        if (print(data, "测试").get("result") == "successed"){
            System.out.println("giligili");
        }
    }

    private static JSONObject print(String data, String name) {
        ...
        // 输出结果
        return Excel.createExcel(deskTopPath + "\\" + name + ".xls", jsonObject);
    }
}
...
class Excel {
    ...
    static JSONObject createExcel(String src, JSONObject json) {
